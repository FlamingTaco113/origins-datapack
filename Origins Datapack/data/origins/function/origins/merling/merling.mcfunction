...
attribute @s minecraft:player.submerged_mining_speed base set 1
...
execute at @s if predicate origins:waterlogged unless block ~ ~ ~ #slabs unless block ~ ~ ~ #stairs unless block ~ ~ ~ #origins:air if score @s merling_haste matches 1 run attribute @s minecraft:player.block_break_speed base set 5
execute at @s unless predicate origins:waterlogged run attribute @s minecraft:player.block_break_speed base set 1


execute at @s if blocks ~ ~1 ~ ~ 319 ~ ~ ~ ~ masked if predicate origins:is_raining if predicate origins:enderian_rain unless biome ~ ~ ~ desert unless biome ~ ~ ~ #minecraft:is_badlands unless biome ~ ~ ~ #minecraft:is_badlands unless biome ~ ~ ~ #minecraft:is_savanna unless dimension minecraft:the_nether run scoreboard players remove @s out_of_water 2
